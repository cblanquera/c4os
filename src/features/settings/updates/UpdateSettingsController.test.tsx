...
import type { UpdateCoordinatorSnapshot } from "../../../platform/update-service";
...
vi.mock("../../../platform/update-service", async () => {
  const actual = await vi.importActual<
    typeof import("../../../platform/update-service")
  >("../../../platform/update-service");
  return { ...actual, ...updateService };
});

vi.mock("../../../platform/runtime-core", async () => {
  const actual = await vi.importActual<
    typeof import("../../../platform/runtime-core")
