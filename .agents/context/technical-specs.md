...
Created: 2026-06-21
Updated: 2026-07-13
Source Note: Replayed from accepted legacy product-model, runtime-adapter, and constraint context. Detailed technical records remain preserved as Raw Source.
...
- [Legacy detailed product model](../resources/history/references/context/technical-specs/product-model.md)
...
- [Legacy runtime-adapter proof findings](../resources/history/references/context/technical-specs/runtime-adapter.md)
...
- [Legacy detailed technical constraints](../resources/history/references/context/technical-specs/constraints.md)
...
- [Legacy extension loading contract](../resources/history/references/context/technical-specs/extension-loading.md)
...
## Architecture And Interface Detail

- [Load the detailed backend architect profile, plugin-tool model, and cross-spec interface contracts](../references/00004-c4os-architecture-and-interface-contracts.md)
  Load when: resolving architecture uncertainty, plugin-tool ownership, service lifecycle, platform boundaries, or shared interfaces.
...
OpenCode proof findings are preserved in the linked legacy runtime-adapter Resource File. Credentialed model-backed prompt execution and live permission-request capture still need validation because the proof avoided provider credentials and token spend.
