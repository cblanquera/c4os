...
| `.agents/references/research/grill-session.md` | Browser and agent authority decision |
| `.agents/specs/research/decisions.md` | Extension enablement and prompt tag decision |
