...
| `scripts/run-task-00004-native-golden.zsh target/debug/bundle/macos/C4OS.app/Contents/Resources` | existing production OpenCode/Pi native provider golden path 1/1 passed after making its Python process-group wrapper safe when already invoked as a process-group leader | 55.07 s |
