...
- `.agents/archive/planning-corpus/preplan-brief.md`
- `.agents/archive/planning-corpus/AGENTS.md`
- `.agents/archive/planning-corpus/research/industry-standards-research.md`
- `.agents/archive/planning-corpus/research/open-questions-and-research-gaps.md`
- `.agents/archive/planning-corpus/specs/requirements-specification.md`
...
- `.agents/archive/planning-corpus/specs/ux-specification.md`
- `.agents/archive/planning-corpus/specs/plugin-system-specification.md`
...
- `.agents/archive/planning-corpus/mvp/mvp-success-metrics.md`
...
- `.agents/archive/planning-corpus/adr/*.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-001-opencode-runtime-control.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-002-policy-enforcement-authority.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-003-local-execution-sandboxing.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-006-standards-conformance-matrix.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-007-tauri-electron-browser-artifacts.md`
...
- `.agents/archive/planning-corpus/spikes/SPIKE-015-marketplace-operational-trust.md`
- `.agents/archive/planning-corpus/acceptance/*.md`
- `.agents/archive/planning-corpus/reviews/architecture-review.md`
- `.agents/archive/planning-corpus/reviews/adr-architecture-review-report.md`
- `.agents/archive/planning-corpus/reviews/risk-analysis.md`
...
`.agents/archive/planning-corpus/specs/architecture-specification.md` says UI-only approvals, post-execution audit, terminal scraping, and best-effort observation are not acceptable enforcement mechanisms. It also states that if protected actions cannot be enforced through OpenCode directly, Phase 0 must choose a wrapper, proxy, fork, runtime replacement, or MVP scope reduction before product implementation continues.

`.agents/archive/planning-corpus/decisions/unresolved-decisions.md` marks ADR-003 OpenCode Runtime Viability as unresolved. `.agents/archive/planning-corpus/spikes/SPIKE-001-opencode-runtime-control.md` is an investigation plan with success criteria, not completed evidence.
...
- `.agents/archive/planning-corpus/adr/004-policy-enforcement-authority.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-001-opencode-runtime-control.md`
...
`.agents/archive/planning-corpus/specs/security-specification.md` makes the Tauri backend the trusted enforcement boundary. `.agents/archive/planning-corpus/specs/architecture-specification.md` makes OpenCode the execution engine but requires it not to bypass the backend Approval Gateway. `.agents/archive/planning-corpus/spikes/SPIKE-002-policy-enforcement-authority.md` depends on SPIKE-001 findings.
...
`.agents/archive/planning-corpus/specs/security-specification.md` and `.agents/archive/planning-corpus/acceptance/shell-execution.md` correctly require filtered environments, destructive command one-time approval, bounded persisted summaries, no raw stdout/stderr fallback, and no strong sandbox claims. `.agents/archive/planning-corpus/decisions/unresolved-decisions.md` still marks shell output redaction limits unresolved. `.agents/archive/planning-corpus/spikes/SPIKE-003-local-execution-sandboxing.md` asks for exact redaction matchers and truncation limits.
...
- `.agents/archive/planning-corpus/adr/010-filesystem-and-shell-access-defaults.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-003-local-execution-sandboxing.md`
...
`.agents/archive/planning-corpus/specs/architecture-specification.md` fixes the selected OpenRouter model at session creation and says OpenCode is not viable if app-selected model routing can be overridden undetectably. `.agents/archive/planning-corpus/acceptance/agent-execution.md` has failure conditions for model override and hidden retry behavior. `.agents/archive/planning-corpus/spikes/SPIKE-009-provider-privacy-cost.md` includes runtime effective model verification as an investigation item.
...
- `.agents/archive/planning-corpus/specs/architecture-specification.md`
- `.agents/archive/planning-corpus/specs/functional-specification.md`
- `.agents/archive/planning-corpus/adr/013-root-agents-md-display-only.md`
- `.agents/archive/planning-corpus/spikes/SPIKE-001-opencode-runtime-control.md`
...
`.agents/archive/planning-corpus/decisions/implementation-readiness-gaps.md` still lists product scope, local execution security, privacy, MCP scope, plugin trust, standards conformance, and other areas as hard blockers. Later artifacts narrow MVP scope and finalize several of those items: `.agents/archive/planning-corpus/decisions/finalized-decisions.md`, `.agents/archive/planning-corpus/mvp/mvp-scope.md`, and the acceptance criteria exclude MCP, plugins, marketplace, browser panels, and non-Git workflows from MVP.
...
`.agents/archive/planning-corpus/specs/plugin-system-specification.md` and `.agents/archive/planning-corpus/specs/marketplace-specification.md` describe future plugin and marketplace behavior. `.agents/archive/planning-corpus/mvp/mvp-scope.md` excludes plugin installation, plugin execution, marketplace, MCP, and marketplace publishing from MVP.
...
- `.agents/archive/planning-corpus/specs/plugin-system-specification.md`
- `.agents/archive/planning-corpus/specs/marketplace-specification.md`
- `.agents/archive/planning-corpus/mvp/mvp-scope.md`
- `.agents/archive/planning-corpus/decisions/deferred-decisions.md`
...
`.agents/archive/planning-corpus/specs/data-model-specification.md` says MVP retains sessions, messages, tool calls, approvals, diagnostics, logs, and artifacts locally and indefinitely by default. Session delete, automatic cleanup, quota management, and export/import are post-MVP.
...
`.agents/archive/planning-corpus/specs/architecture-specification.md` recommends Tauri and excludes browser-heavy surfaces from MVP. `.agents/archive/planning-corpus/decisions/finalized-decisions.md` says Tauri is finalized for MVP but calls for WebView validation. `.agents/archive/planning-corpus/spikes/SPIKE-007-tauri-electron-browser-artifacts.md` exists for platform validation.
...
`.agents/archive/planning-corpus/specs/functional-specification.md`, `.agents/archive/planning-corpus/specs/data-model-specification.md`, and `.agents/archive/planning-corpus/acceptance/agent-execution.md` exclude message edit/delete, retry-in-place, branch-from-failure, transcript pruning, and automatic retry. Provider failures and stop actions append or update status rather than rewrite history.
...
`.agents/archive/planning-corpus/acceptance/agent-execution.md`, `.agents/archive/planning-corpus/acceptance/security-and-permissions.md`, `.agents/archive/planning-corpus/acceptance/file-access.md`, and `.agents/archive/planning-corpus/acceptance/shell-execution.md` include both user-visible pass/fail behavior and architecture viability conditions such as OpenCode config override prevention and pre-execution control.
...
`.agents/archive/planning-corpus/preplan-brief.md` was added from the original project brief and says to create a `plans` folder and produce twelve documents. The corpus already exists and is more detailed than the brief.
...
- `.agents/archive/planning-corpus/adr/00-adr-candidate-list.md`
- `.agents/archive/planning-corpus/adr/00-proposed-adr-priority-order.md`
- `.agents/archive/planning-corpus/decisions/finalized-decisions.md`
- `.agents/archive/planning-corpus/decisions/deferred-decisions.md`
...
- `.agents/archive/planning-corpus/decisions/implementation-readiness-gaps.md` still lists several old hard blockers that later documents resolve, narrow, or defer.
- `.agents/archive/planning-corpus/preplan-brief.md` frames the product as general-purpose, while MVP scope and requirements correctly narrow to coding-first validation.
...
- Reconcile `.agents/archive/planning-corpus/decisions/implementation-readiness-gaps.md` with finalized and deferred decisions.
