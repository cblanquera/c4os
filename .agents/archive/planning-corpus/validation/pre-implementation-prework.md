...
acceptance gate separation are now recorded in `.agents/archive/planning-corpus/validation/`.
...
- `.agents/archive/planning-corpus/decisions/unresolved-decisions.md` no longer lists any BLOCKER or HIGH item without a resolution, accepted risk, or explicit deferral.
...
8. Run Workstream 6.
9. Run Workstream 7.
10. Update `.agents/archive/planning-corpus/validation/evidence-matrix.md`.
11. Record decisions in `.agents/archive/planning-corpus/validation/decision-log.md`.
