...
Related spikes:
 ...
 - `.agents/archive/planning-corpus/spikes/SPIKE-000-name.md`
...
Evidence:
 ...
 - `.agents/archive/planning-corpus/validation/acceptance-gate-separation.md`
...
Evidence:
 ...
 - `.agents/archive/planning-corpus/validation/FINDING-001-phase0-harness-run.md`
...
Follow-up updates:
 ...
 - Keep `.agents/archive/planning-corpus/validation/evidence-matrix.md` runtime-control rows as not
