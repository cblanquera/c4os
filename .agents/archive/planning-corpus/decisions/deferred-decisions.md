...
Affected documents:
 ...
 - `.agents/archive/planning-corpus/spikes/SPIKE-011-large-workspace-and-concurrency.md`
...
Affected documents:
 ...
 - `.agents/archive/planning-corpus/adr/015-marketplace-model.md`
 - `.agents/archive/planning-corpus/mvp/mvp-scope.md`
...
Affected documents:
 ...
 - `.agents/archive/planning-corpus/adr/016-plugin-trust-and-execution.md`
 - `.agents/archive/planning-corpus/mvp/mvp-scope.md`
 - `.agents/archive/planning-corpus/spikes/SPIKE-005-plugin-format-and-trust.md`
...
Affected documents:
 ...
 - `.agents/archive/planning-corpus/spikes/SPIKE-012-ux-onboarding-concept-load.md`
