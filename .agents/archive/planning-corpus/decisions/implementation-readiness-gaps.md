...
`.agents/archive/planning-corpus/decisions/unresolved-decisions.md`, and the validation artifacts under
`.agents/archive/planning-corpus/validation/`. Do not use this file as the current readiness source.
