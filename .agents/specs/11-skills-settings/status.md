...
- Skills Settings gaps are resolved toward standards-first,
  metadata-first skill discovery, explicit source precedence, no runtime impact
  from invalid or disabled skills, supply-chain-aware filtering, and
  worker-friendly skill language.
