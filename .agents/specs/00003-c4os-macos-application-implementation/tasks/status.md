...
| --- | --- | --- | --- |
| [00001 Foundation and dependency lock](00001-foundation-and-dependency-lock.md) | open | failed | Foundation for all IDs |
| [00002 Durable core, configuration, and Workspace lifecycle](00002-durable-core-configuration-workspace.md) | open | failed | UX-013, UX-014, SET-002 |
...
| [00009 Terminal facility](00009-terminal-facility.md) | open | failed | ART-005 |
...
| [00015C Coverage and closeout audit](00015C-coverage-closeout-audit.md) | open | failed | All 50 IDs and final records |

## Current Blockers

None. Production code is absent, so every implementation and Agent Acceptance gate is initially open/failed by lack of evidence rather than by an external blocker.
