...
| REQ-005 | Document-family plugins own .docx/.xlsx previews; Browser can host rendered output. Browser-native PDF preview comes first; advanced PDF plugin is separate. |
