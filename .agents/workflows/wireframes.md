...
Use this for low-fidelity screens, flows, layout notes, and interface review.
...
5. Promote accepted handoff decisions into `.agents/context/` and relevant specs before implementation depends on them.
