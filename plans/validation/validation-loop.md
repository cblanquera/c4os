...
as the validation loop record; use `plans/decisions/unresolved-decisions.md`
...
Run the mandatory research spikes and capture evidence in `plans/validation/evidence-matrix.md`.
...
Record decisions in `plans/validation/decision-log.md`.
...
The validation loop exits successfully when:
 ...
 - No BLOCKER or HIGH findings remain in `plans/decisions/unresolved-decisions.md`.
