...
| `tools/run-task-00004-native-golden.zsh` | existing private-TLS OpenCode/Pi native golden 1/1 passed against the rebuilt bundle | 57.68 s |
...
- The unrelated `src/generated/MarketplaceSnapshot.ts` whitespace diff and Task 00006 screenshot change remain outside this evidence and checkpoint.
