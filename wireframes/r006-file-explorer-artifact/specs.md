# File Explorer Artifact Wireframe Specification

## Revision Summary

- Revision folder: `wireframes/r006-file-explorer-artifact/`
- Revision: `r006-file-explorer-artifact`
- Status: New major revision copied forward from `wireframes/r005-left-chat-pane/specs.md`.
