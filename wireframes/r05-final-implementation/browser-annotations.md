...
Status: markdown-only Batch 5 note. The rendered r05 wireframe no longer
includes `#browser-annotations`.

## Scope

Browser annotation behavior is not represented as a standalone right-panel
wireframe route in Batch 5. The visible Browser review surface is limited to:
...
this Batch 5 review is explicitly approved.
