# C4OS Cleanup Wireframe Specification

## Revision Summary

- Revision folder: `wireframes/r012-cleanup/`
- Revision: `r012-cleanup`
- Status: Code-style cleanup copied forward in full from `wireframes/r011-workspace-projects/`.
- Product area: Workspace project and chat-session navigation, provider-dependent launch, desktop AI workspace, and application-level Settings management.
- Requested scope:
...
- Trigger: User request to add workspace projects and chat sessions to the left panel, dated 2026-07-17.
