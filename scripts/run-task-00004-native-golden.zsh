...
readonly C4OS_PROVIDER_EVIDENCE="$C4OS_PROJECT_ROOT/tests/results/native/task-00004-provider-evidence.json"
readonly C4OS_RESOURCE_ROOT="${1:-$C4OS_PROJECT_ROOT/.build/app/debug/bundle/macos/C4OS.app/Contents/Resources}"
...
/bin/mkdir -p "$C4OS_PROJECT_ROOT/tests/results/native"
