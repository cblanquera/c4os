...
import { WorkspaceStartRoute } from "../../../../src/frontend/features/workspace/WorkspaceStartRoute";
...
vi.mock("../../../../src/frontend/platform/platform-service", async () => {
  const actual = await vi.importActual<
    typeof import("../../../../src/frontend/platform/platform-service")
  >("../../../../src/frontend/platform/platform-service");
