...
import type {
  ...
  DiagnosticsSnapshot,
} from "../../../../../src/frontend/platform/diagnostic-service";
import { DiagnosticSettingsController } from "../../../../../src/frontend/features/settings/diagnostics/DiagnosticSettingsController";
...
vi.mock("../../../../../src/frontend/platform/diagnostic-service", async () => {
