...
import type { ProviderSettingsSnapshot } from "../../../../src/frontend/platform/provider-service";
import type { StartupRecoverySnapshot } from "../../../../src/frontend/platform/startup-recovery-service";
import { ProtocolBoundaryError } from "../../../../src/frontend/platform/tauri-adapter";
import {
  LaunchRoute,
  ProviderRouteGate,
} from "../../../../src/frontend/features/shell/LaunchRoute";
...
vi.mock(
  "../../../../src/frontend/platform/startup-recovery-service",
  async () => {
    const actual = await vi.importActual<
      typeof import("../../../../src/frontend/platform/startup-recovery-service")
    >("../../../../src/frontend/platform/startup-recovery-service");
    return { ...actual, ...startupRecoveryService };
  },
);

vi.mock("../../../../src/frontend/platform/workspace-start", async () => {
  const actual = await vi.importActual<
    typeof import("../../../../src/frontend/platform/workspace-start")
  >("../../../../src/frontend/platform/workspace-start");
