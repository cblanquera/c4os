...
import { TerminalArtifact } from "../../../../../src/frontend/features/artifacts/terminal/TerminalArtifact";
import type { TerminalArtifactModel } from "../../../../../src/frontend/features/artifacts/terminal/terminal-types";

vi.mock(
  "../../../../../src/frontend/features/artifacts/terminal/TerminalViewport",
  () => ({
    TerminalViewport: ({
      accessibleLabel,
      onOutputWritten,
